...
CREATE USER IF NOT EXISTS 'webserviceuser'@'localhost' IDENTIFIED BY 'P@ssw0rd.123';

GRANT USAGE ON * . * TO 'webserviceuser'@'localhost' IDENTIFIED BY 'P@ssw0rd.123' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

GRANT SELECT , INSERT , UPDATE , DELETE , CREATE , DROP , INDEX , ALTER , CREATE TEMPORARY TABLES , CREATE VIEW , SHOW VIEW , CREATE ROUTINE, ALTER ROUTINE, EXECUTE ON `webserviceuser` . * TO 'webserviceuser'@'localhost';
